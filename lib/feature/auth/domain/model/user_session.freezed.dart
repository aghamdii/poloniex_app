...
class _$UserSessionImpl implements _UserSession {
  _$UserSessionImpl({required this.accessToken, required this.refreshToken});
  ...
  @override
  String toString() {
    return 'UserSession(accessToken: $accessToken, refreshToken: $refreshToken)';
  }
...
abstract class _UserSession implements UserSession {
  factory _UserSession(
      ...
      required final String refreshToken}) = _$UserSessionImpl;
